 ...
 * Create date: 2014/08/20 (yyyy/MM/dd)
 * Description: Service Battery in Factory
 */
using System;
...
{
    /// <summary>
    /// Form for service batteries in factory
    /// </summary>
    public partial class frmServiceBatteriesInFactory : Form
    {
        /// <summary>
        /// Logger for frmServiceBatteriesInFactory
        /// </summary>
        private static readonly ILog _logger = LogManager.GetLogger(typeof(frmServiceBatteriesInFactory));
        ...
        private void LoadNBindStatus()
        {
            try
            {
                this.dgvStatus.DataSource = new ReportBL().GetServiceBatteryInFactory();
            }
            catch (Exception e)
            {
                _logger.Error(e);
        ...
        #region Constructors
        public frmServiceBatteriesInFactory()
        {
            InitializeComponent();
            // Disable auto-genearte columns
