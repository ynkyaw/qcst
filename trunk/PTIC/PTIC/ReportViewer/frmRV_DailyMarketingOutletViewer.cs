...
{
    public partial class frmRV_DailyMarketingOutletViewer : Form
    {
        /// <summary>
        ...
        public frmRV_DailyMarketingOutletViewer()
        {
            InitializeComponent();
            LoadNBindSearch();
        ...
        private void Search()
        {
            ...
            DataTable dt = new ReportBL().DailyMarketingSelectBy(TripID, RouteID, TownID, TownshipID, CustomerType, StartDate, EndDate);
            rpDailyMarketingViewer.Visible = true;
            rpDailyMarketingViewer.LocalReport.ReportEmbeddedResource = "PTIC.Report.DailyMarketingReport.rdlc";
            rpDailyMarketingViewer.LocalReport.DataSources.Clear();
            rpDailyMarketingViewer.LocalReport.DataSources.Add(new ReportDataSource("DailyMarketingReportDataSet", dt));
            rpDailyMarketingViewer.RefreshReport();
        ...
        private void frmRV_DailyMarketingOutletViewer_Load(object sender, EventArgs e)
        {

            this.rpDailyMarketingViewer.RefreshReport();
        }
        ...
        private void frmRV_DailyMarketingOutletViewer_FormClosing(object sender, FormClosingEventArgs e)
        {
            rpDailyMarketingViewer.LocalReport.ReleaseSandboxAppDomain();
        }
    }
}
